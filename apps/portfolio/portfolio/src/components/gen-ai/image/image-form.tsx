...
import { useActionData, useSubmit, Form, useNavigation } from 'react-router-dom';
...
const ImageForm = () => {
  ...
  return (
    ...
    >
      <Paper key={'image-gen-paper'} id="image-gen-paper">
        <Container
          component={'section'}
          key={'image-gen'}
          id="image-gen"
        ...
        >
          ...
          >
            ...
            <Box key={'image-gen-button-box'} id="image-gen-button-box">
              {state !== 'submitting' ? (
                <Button
                  type="submit"
                ...
                <>
                  <Text titleVariant="h4" titleText={'Generating'} />
                  <Waiting />
                </>
              )}
            </Box>
