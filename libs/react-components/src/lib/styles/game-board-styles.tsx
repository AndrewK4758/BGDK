...
export const nonSelectedSpaceStyle: CSSProperties = { backgroundColor: Theme.palette.background.default };

export const selectedSpaceStyle: CSSProperties = { backgroundColor: '#FFD300', color: '#58278b' };

export const svgSpaceTTTStyles: SxProps = { position: 'absolute', display: 'flex', justifyContent: 'center', flex: 1 };
